...
export const allMovies: Movie[] = [
    { 
        ...
        img: "/media/etc/dune2.jpg", className: "cu1_set1",
    ...
    img: "/media/etc/black_swan.jpg", className: "cu3_set5",
    ...
    { 
        ...
        img: "/media/etc/martian.jpg", className: "ex_set12",
    ...
    { 
        ...
        img: "/media/etc/007.jpg", className: "ex_set13",
    ...
    { 
        ...
        img: "/media/etc/budapest.jpg", className: "ex_set14",
    ...
    { 
        ...
        img: "/media/etc/french.png", className: "ex_set15",
    ...
    { 
        ...
        img: "/media/etc/london.jpg", className: "ex_set16",
    ...
    { 
        ...
        img: "/media/etc/escaperoom.jpg", className: "ex_set17",
    ...
    { 
        ...
        img: "/media/etc/tenet.jpg", className: "cu3_set18",
